...
I feel like I understand it so much better now since I was personally invested in the project for my own resume.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

A gap that came up was implementing methods that used APIs. In order to address this gap, I watched tutorials on YouTube and did some Googling.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

I still enjoy Software Engineering, even a little more now I'd say, since I had the oppurtunity to make something out of almost nothing. I value that very much, since it's like "building LEGOs" as all engineers say.
...
Like I mentioned before, I learned how to implement methods using an API, which was super cool for me since it brought in data from the real world instead of hypothetical data from something like an input file.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

- Designed a reusable Java component that models the exchange rates of different currencies to USD
- Pulls current exchange rates from an API
- Allows users to input and define their own exchange rates, such as reward points

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

I love the tpoic I picked. My goal was to use this as a stepping stone to make some sort of reward tracker app that tracks credit card spending and rewards.
...
To continue my trajectory, I could learn more software development tools, like different programming languages or frameworks. I can also rely on Jeremy and all of my other professors and peers to stay on this path.
